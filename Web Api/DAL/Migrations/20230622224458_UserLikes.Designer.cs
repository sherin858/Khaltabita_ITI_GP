...
namespace DAL.Migrations
{
    ...
    [Migration("20230622224458_UserLikes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MenuItemUser", b =>
                {
                    b.Property<int>("LikedMenuItemsId")
                        .HasColumnType("int");

                    b.Property<string>("UsersLikingItId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("LikedMenuItemsId", "UsersLikingItId");

                    b.HasIndex("UsersLikingItId");
            ...
            modelBuilder.Entity("MenuItemUser", b =>
                {
                    b.HasOne("DAL.Models.MenuItem", null)
                        .WithMany()
                        .HasForeignKey("LikedMenuItemsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DAL.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UsersLikingItId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
